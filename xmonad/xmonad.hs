...
import XMonad.Actions.CycleWS (anyWS, hiddenWS, ignoringWSs, wsTagGroup, prevWS, nextWS, shiftToPrev, shiftToNext, Direction1D(..), moveTo, shiftTo, WSType(..), nextScreen, prevScreen, toggleWS, emptyWS)
--import XMonad.Actions.GridSelect
...
myTreeNavigation = M.fromList
    ...
    , ((mod4Mask, xK_5), TS.moveTo ["{Random}", "$Terminals", "~1"])
    , ((mod4Mask, xK_t), TS.moveTo ["{Random}", "@Applications", "~1"])
    , ((mod4Mask, xK_g), TS.moveTo ["{Random}", "#Browsers", "~1"])
    , ((mod4Mask, xK_b), TS.moveTo ["{Random}", "|Scratch|", "~1"])
    ]
...
-- Incomplete code follows. Need to finish defining projects for DynamicProjects module.
...
projects =
  ...
  , Project { projectName      = "{Random}.|Scratch|"
            , projectDirectory = "/Documents"
            , projectStartHook = Just $ do spawn "emacsclient -c -a 'emacs' --eval '(dashboard-refresh-buffer)'"
            }
  ...
  , Project { projectName      = "{Random}.$Terminals"
            , projectDirectory = "/tmp"
            , projectStartHook = Just $ do spawn myTerminal
            }
  ...
  , Project { projectName      = "{Random}.#Browsers"
            , projectDirectory = "/tmp"
...
--myWorkspaces = withScreens 2 [" dmt ", " lsd ", " shrooms ", " peace ", " love ", " happiness ", " hack ", " code ", " trade "]
...
--
  ...
  , ("M-S-`", addName "test"                                   $ TS.treeselectWorkspace tsDefaultConfig myWorkspaces W.shift)
  , ("M-`", addName "test"                                   $ TS.treeselectWorkspace tsDefaultConfig myWorkspaces W.greedyView)
--  , ("M-M1-o" addName "test"                                   $ shiftTo Next (wsTagGroup '.'))
  , ("M-1", addName "Switch to Next Misc Page"               $ moveTo Next $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('$' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-M1-1", addName "Switch to Next Misc Page"               $ shiftTo Next $ hiddenWS :&: (anyWS) :&: ((WSIs $ return (('$' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-2", addName "Switch to Next Misc Page"               $ moveTo Next $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('@' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-M1-2", addName "Switch to Next Misc Page"               $ shiftTo Next $ hiddenWS :&: (anyWS) :&: ((WSIs $ return (('@' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-3", addName "Switch to Next Misc Page"               $ moveTo Next $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('#' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-M1-3", addName "Switch to Next Misc Page"               $ shiftTo Next $ hiddenWS :&: (anyWS) :&: ((WSIs $ return (('#' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-4", addName "Switch to Next Misc Page"               $ moveTo Next $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('|' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-M1-4", addName "Switch to Next Misc Page"               $ shiftTo Next $ hiddenWS :&: (anyWS) :&: ((WSIs $ return (('|' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('<' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('!' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-5", addName "Switch to Next Misc Page"               $ moveTo Next $ hiddenWS :&: (Not emptyWS)                                              :&: (Not (WSIs $ return (('$' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('@' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('#' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('|' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     ...
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-6", addName "Switch to Next Programming Page"        $ moveTo Next ((WSIs $ return (('H' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Hacking}"]))
  , ("M-7", addName "Switch to Next Programming Page"        $ moveTo Next ((WSIs $ return (('P' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Programming}"]))
  , ("M-8", addName "Switch to Next Media Page"              $ moveTo Next ((WSIs $ return (('M' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Media}"]))
  , ("M-9", addName "Switch to Next Social Page"             $ moveTo Next ((WSIs $ return (('S' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Social}"]))
  , ("M-0", addName "Switch to Next Misc Page"               $ moveTo Next ((WSIs $ return (('R' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Random}"]))
  , ("M-S-1", addName "Switch to Next Misc Page"             $ moveTo Prev $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('$' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag))))
  , ("M-S-2", addName "Switch to Next Misc Page"             $ moveTo Prev $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('@' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag))))
  , ("M-S-3", addName "Switch to Next Misc Page"             $ moveTo Prev $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('#' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag))))
  , ("M-S-4", addName "Switch to Next Misc Page"             $ moveTo Prev $ hiddenWS :&: (Not emptyWS) :&: ((WSIs $ return (('|' `elem`) . W.tag))) :&: (Not (WSIs $ return (('>' `elem`) . W.tag))))
  , ("M-S-5", addName "Switch to Next Misc Page"             $ moveTo Prev $ hiddenWS :&: (Not emptyWS)                                              :&: (Not (WSIs $ return (('$' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('@' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('#' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('|' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('>' `elem`) . W.tag)))
                                                                                                                                                     ...
                                                                                                                                                     :&: (Not (WSIs $ return (('+' `elem`) . W.tag)))
                                                                                                                                                     :&: (Not (WSIs $ return (('~' `elem`) . W.tag))))
  , ("M-S-6", addName "Switch to Next Programming Page"        $ moveTo Prev ((WSIs $ return (('H' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Hacking}"]))
  , ("M-S-7", addName "Switch to Next Programming Page"        $ moveTo Prev ((WSIs $ return (('P' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Programming}"]))
  , ("M-S-8", addName "Switch to Next Media Page"              $ moveTo Prev ((WSIs $ return (('M' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Media}"]))
  , ("M-S-9", addName "Switch to Next Social Page"             $ moveTo Prev ((WSIs $ return (('S' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Social}"]))
  , ("M-S-0", addName "Switch to Next Misc Page"               $ moveTo Prev ((WSIs $ return (('R' `elem`) . W.tag)) :&: (Not emptyWS) :&: ignoringWSs ["{Random}"]))
